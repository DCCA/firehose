# Tasks: Make the repo share-worthy

## Checklist

- [x] 1. Add CONTRIBUTING.md (dogfoods the Firehose workflow).
- [x] 2. Add CODE_OF_CONDUCT.md (Contributor Covenant 2.1, placeholder contact).
- [x] 3. Add SECURITY.md (lightweight, docs-repo appropriate).
- [x] 4. Add .gitignore (OS/editor + ephemeral .docs/ paths).
